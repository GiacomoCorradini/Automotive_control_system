...
for i=1:length(omega__wheel)
    Tw_1(i) = MotorModel(Tm_req_1,omega__wheel(i),params);
end   
...
for i=1:length(omega__wheel)
    Tw_2(i) = MotorModel(Tm_req_2,omega__wheel(i),params);
end 
...
for i=1:length(omega__wheel)
    Tw_3(i) = MotorModel(Tm_req_3,omega__wheel(i),params);
end
...
for i=1:length(omega__wheel)
    Tw_4(i) = MotorModel(Tm_req_4,omega__wheel(i),params);
end
...
for i=1:length(omega__wheel)
    Tw_5(i) = MotorModel(Tm_req_5,omega__wheel(i),params);
end
...
for i=1:length(omega__wheel)
    Tw_6(i) = MotorModel(Tm_req_6,omega__wheel(i),params);
end
...
for i=1:length(omega__wheel)
    Tw_7(i) = MotorModel(Tm_req_7,omega__wheel(i),params);
end
