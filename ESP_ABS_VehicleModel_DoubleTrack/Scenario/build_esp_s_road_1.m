function build_esp_s_road_1()
    ...
    y_path = [y_path; y_path(end)+2.5; y_path(end)+5];
    theta_path = [theta_path; theta_path(end)+pi/4; 0];

    % ------------------
    % Middle straight line
    % ------------------
    length_middle_straight = 10;
    x_path = [x_path; x_path(end)+length_middle_straight];
    ...
    save('./Scenario/esp_s_road_1','path','times','vehicle_control')
